 ...
 */
export type KeyPaths<T, K extends keyof T = keyof T> = string &
  (
...
type InferredPathTest = Spec<
  [
    Equals<
      InferredPathType<TestType, "root">, 
      string
    >,
    Equals<
      InferredPathType<TestType, "foo">,
      { bar: number; baz: { exhausted: { reached: true } } }
    >,
    Equals<
      InferredPathType<TestType, "foo.bar">, 
      number
    >,
    Equals<
      InferredPathType<TestType, "foo.baz">,
      { exhausted: { reached: true } }
    >,
    Equals<
      InferredPathType<TestType, "foo.baz.exhausted">, 
      { reached: true }
    >,
    Equals<
      InferredPathType<TestType, "foo.baz.exhausted.reached">, 
      true
    >,
    Equals<
      InferredPathType<TestType, "foo.baz.exhausted.optional">,
      "Option" | undefined
    >
  ]
>;
